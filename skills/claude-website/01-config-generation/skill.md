...
# Supabase — self-hosted VPS via Cloudflare proxy → Kong:8000
# LAA canonical URL: https://laadvisory.com.my/api  (NOT supabase.co — self-hosted)
...
> See `claude/laa-api-connection-htaccess/skill.md` for the full self-hosted topology, exact credentials, and .htaccess patterns for all 4 LAA projects.
