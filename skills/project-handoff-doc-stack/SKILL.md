...
- When a doc needs to be AI-friendly, add a YAML frontmatter router block that names the file, its purpose, its aliases/triggers, and the related docs or skills it should load next.
...
If the user says `ai hybrid metadata router`, `ai metadata router`, or `ai project knowledge template`, prefer the hybrid frontmatter router note before loading broader handoff docs.
