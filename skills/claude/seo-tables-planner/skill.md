...
verification:
  - Confirm the SEO table plan covers schema, permissions, and route-keyed lookup.
  - Keep custom-detail exclusions explicit before implementation starts.
---
