...
verification:
  - Confirm the fields, relationships, and placeholders before any generation step starts.
  - Keep the analysis as the authoritative input for downstream subskills.
---
