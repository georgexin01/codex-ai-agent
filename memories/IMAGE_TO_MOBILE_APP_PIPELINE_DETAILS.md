...
When the user provides a folder of mobile-app design images, this skill builds a complete Vue mobile app that clones the aesthetic. The workflow is turnkey once the trigger conditions are met.
