...
scope: Use when the user asks for multi-step implementation status, page-wide update coverage, clearer completion reporting, or detailed comparison metrics across any workspace.
...
## Task 2: Add detailed comparison metrics only when the user asks for richer before/after or optimization tables, extension-backed

### rollout_summary_files

- extensions/ad_hoc/notes/2026-07-16T00-30-00-detailed-chat-table-metrics.md (cwd=workflow-global, rollout_path=C:\Users\user\.codex\memories\extensions\ad_hoc\notes\2026-07-16T00-30-00-detailed-chat-table-metrics.md, updated_at=2026-07-16T00:30:00, thread_id=extension-ad-hoc-detailed-chat-table-metrics, authoritative extension note) [ad-hoc note]

### keywords

- detailed tables, comparison table, before/after, optimization, improvement %, token cost, speed increase %, intelligence rating, chat flow rating, estimated metrics
...
- when the user asks for comparison, before/after, optimization, or "more info in tables", keep the compact status table and add dedicated metrics columns or a second comparison table instead of replacing the base table [Task 2] [ad-hoc note]
...
- The detailed comparison add-ons requested here are: improvement percentage, rating out of 10, estimated token cost, speed and speed increase percentage, intelligence/context quality rating out of 10, and AI chat-flow/reply quality rating out of 10 [Task 2] [ad-hoc note]
...
- Do not present the extra comparison metrics as exact benchmark results unless they were measured from current evidence; clearly label estimates and do not force the expanded columns into ordinary status tables when the user did not ask for them [Task 2] [ad-hoc note]
