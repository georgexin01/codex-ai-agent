...
Executable companion to the tier-0 [SOVEREIGN_BLUEPRINT_PROTOCOL.md](0_apex/SOVEREIGN_BLUEPRINT_PROTOCOL.md). Use this when the user wants a project documented into `BLUEPRINT.md` or `APP_BLUEPRINT.md`.

## 0. Fast Reading Notes

- Keep the rules imperative.
- Prefer tables for structured data.
- Cite the source protocol when a rule depends on it.
- Keep each turn to a small number of sub-tasks.
- Use the verification mandate before declaring completion.
